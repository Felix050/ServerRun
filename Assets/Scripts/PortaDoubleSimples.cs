...
public class PortaDoubleSimples : MonoBehaviour {

	//public Animator _animator;

	public GameObject portaDouble;
    ...
    void Update()
    {
        ...
        if (_naoestaporta == false)
        {
            ...
            {  
                portaDouble.GetComponent<Animator>().SetBool("DoubleAbrindo", true);
        ...
        if (primer)
        {
            ...
            if(entrou == false)
            {
                ...
                if (_estanaporta && Input.GetKey(KeyCode.E))
                {
                    portaDouble.GetComponent<Animator>().SetBool("DoubleAbrindo", false);
